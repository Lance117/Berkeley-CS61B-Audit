...
- proj3: Bear Maps. This is a web mapping application that allows users to explore and find the shortest path between two points in Berkeley, with turn-by-turn directions
###
| File | Description |
| --- | --- |
...
| [Router](https://github.com/LanceSanity/Berkeley-CS61B-Audit/blob/master/proj3/src/main/java/Router.java) | Uses A* search algorithm to find the shortest path between two points in Berkeley; uses shortest path to generate navigation directions. Todo: Autocomplete, Search |
